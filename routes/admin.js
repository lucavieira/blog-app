...
const {isAdm} = require('../helpers/isadmin')
...
router.get('/category', isAdm, (req, res) => {
...
router.get('/category/add', isAdm, (req, res) => {
    res.render('admin/addcategory')
})

router.post('/category/new', isAdm, (req, res) => {
...
router.get('/category/edit/:id', isAdm, (req, res) => {
...
router.post('/category/edit', isAdm, (req, res) => {
...
router.post('/category/delete', isAdm, (req, res) => {
